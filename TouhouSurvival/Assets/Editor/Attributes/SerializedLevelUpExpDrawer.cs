...
namespace Unchord.Editor
{
    ...
    public class SerializedLevelUpExpDrawer : PropertyDrawer
    {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            SerializedProperty pLev = property.FindPropertyRelative("currentLevel");
            ...
            EditorGUI.PropertyField(new Rect(rect.x, rect.y, fieldSpace, rect.height), pLev, new GUIContent("Current Level"));
            EditorGUI.PropertyField(new Rect(rect.x + fieldSpace + spaceUnit, rect.y, fieldSpace, rect.height), pReq, new GUIContent("Level Up Exp Requirement"));
